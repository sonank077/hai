...
- /attack + [methods] + [ IP ] port 5000 5000 60 
- /methods : Để Xem Methods
- /check + [host] : Kiểm Tra AntiDDoS
- /proxy : Check Số Lượng Proxy 100.000 proxy
- /tcp : ví dụ : 1.1.1.1 port 5000 5000 60 [ 3 dòng Cuối dữ Nguyên Không Sẽ Bị Kích )
4️⃣ Lệnh Có Ích ^^
...
TLS
DESTROY
CF-BYPASS Ví Dụ : https://chinhphu.vn/
[ Được Pem Gov, Edu]
GOD 
🚀 Layer4
TCP-FLOOD 1.1.1.1 port 5000 5000 60 
UDP-FLOOD
'''
    bot.reply_to(message, help_text)
